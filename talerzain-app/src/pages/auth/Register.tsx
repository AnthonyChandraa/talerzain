...
import fotoRegister from '../../assets/Assets [Talerzain]/Assets [Talerzain]/Signup Signin/Restorer.gif'
...
function Register() {
  return (
    ...
    <div className='d-flex justify-content-center align-items-center ps-4 pe-4' style={{width: "282px", height:"282px"}}>
      <img src={fotoRegister} alt="no photo" className='photo rounded-5' style={{width: "280px"}}/>
    </div>
    <div className='bg-yellow-op-5 sign-in-right'>
        <div className='d-flex justify-content-start w-75'>
          <p className='m-4 h4'>Sign Up</p>
        </div>
        <div className='d-flex flex-column mb-3'>
          <label className='mini-links' htmlFor="form-email">Email</label>
          <input className='form-input shadow-btn ' type="email" id='form-email' placeholder='insert email'/>
        </div>
        <div className='d-flex flex-column mb-3'>
        ...
        <div className='d-flex flex-column mb-3'>
          <label className='mini-links' htmlFor="form-conf-password">Confirm Password</label>
          <input className='form-input shadow-btn ' type="password" id='form-conf-password' placeholder='confirm your password'/>
        </div>
        <div className='d-flex flex-column align-items-center'>
          <button className='rounded-4 btn-sign bg-red shadow-btn in-button'>Sign Up</button>
          <a className='mini-links m-2' href="">Already have an account?</a>
        </div>
        <div className='align-items-center d-flex flex-column' style={{gap: "10px"}}>
          <p className='mini-links'> ─── &nbsp; or sign up with &nbsp; ─── </p>
